...
def generate_launch_description():
    ...
    pkg_simulator = get_package_share_directory("qdu2026_gazebo_simulator")
    pkg_robot_description = get_package_share_directory("pb2025_robot_description")

    robot_xmacro_path = os.path.join(
        pkg_robot_description, "resource", "xmacro", "simulation_robot.sdf.xmacro"
    )
    ...
    for robot in robots:
        ...
        robot_base = Node(
            package="qdu2026_gazebo_simulator",
