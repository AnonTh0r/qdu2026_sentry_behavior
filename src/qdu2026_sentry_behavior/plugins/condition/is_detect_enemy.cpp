...
#include "qdu2026_sentry_behavior/plugins/condition/is_detect_enemy.hpp"
...
{
  factory.registerNodeType<qdu2026_sentry_behavior::IsDetectEnemyCondition>("IsDetectEnemy");
}
