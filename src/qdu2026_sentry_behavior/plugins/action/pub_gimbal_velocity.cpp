...
#include "qdu2026_sentry_behavior/plugins/action/pub_gimbal_velocity.hpp"
...
bool PublishGimbalVelocity::setMessage(referee_interfaces::msg::GimbalCmd & msg)
{
  msg.header.stamp = node_->now();
  msg.yaw_type = referee_interfaces::msg::GimbalCmd::VELOCITY;
  msg.pitch_type = referee_interfaces::msg::GimbalCmd::VELOCITY;
...
CreateRosNodePlugin(qdu2026_sentry_behavior::PublishGimbalVelocity, "PublishGimbalVelocity");
