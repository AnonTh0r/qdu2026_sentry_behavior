...
#include "qdu2026_sentry_behavior/plugins/action/calculate_attack_pose.hpp"
...
CreateRosNodePlugin(qdu2026_sentry_behavior::CalculateAttackPoseAction, "CalculateAttackPose");
