...
#include "qdu2026_sentry_behavior/plugins/action/pub_gimbal_absolute.hpp"
...
bool PublishGimbalAbsolute::setMessage(referee_interfaces::msg::GimbalCmd & msg)
{
  msg.header.stamp = node_->now();
  msg.yaw_type = referee_interfaces::msg::GimbalCmd::ABSOLUTE_ANGLE;
  msg.pitch_type = referee_interfaces::msg::GimbalCmd::ABSOLUTE_ANGLE;
  ...
  msg.velocity = referee_interfaces::msg::Gimbal();
...
CreateRosNodePlugin(qdu2026_sentry_behavior::PublishGimbalAbsolute, "PublishGimbalAbsolute");
