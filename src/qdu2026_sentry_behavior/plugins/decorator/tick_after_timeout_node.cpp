...
#include "qdu2026_sentry_behavior/plugins/decorator/tick_after_timeout_node.hpp"
...
{
  factory.registerNodeType<qdu2026_sentry_behavior::TickAfterTimeout>("TickAfterTimeout");
}
