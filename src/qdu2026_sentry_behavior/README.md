...
[![Build and Test](https://github.com/SMBU-PolarBear-Robotics-Team/qdu2026_sentry_behavior/actions/workflows/ci.yml/badge.svg)](https://github.com/SMBU-PolarBear-Robotics-Team/qdu2026_sentry_behavior/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/SMBU-PolarBear-Robotics-Team/qdu2026_sentry_behavior.git src/qdu2026_sentry_behavior
```

```bash
vcs import --recursive src < src/qdu2026_sentry_behavior/dependencies.repos
```
