...
#include "qdu2026_sentry_behavior/qdu2026_sentry_behavior_client.hpp"
...
: Node("sentry_behavior_client", options)
{
  ...
  action_client_ = rclcpp_action::create_client<BTExecuteTree>(this, "qdu2026_sentry_behavior");
...
RCLCPP_COMPONENTS_REGISTER_NODE(qdu2026_sentry_behavior::SentryBehaviorClient)
